...
import org.d3ifcool.cloure.db.DataBase;
import org.d3ifcool.cloure.entities.Day;
import org.d3ifcool.cloure.listeners.ToWindowOnClick;
import org.d3ifcool.cloure.listeners.ToWindowOnClickWithClosing;
import org.d3ifcool.cloure.preferences.Profile;
import org.d3ifcool.cloure.utils.MyDate;
...
public class DiaryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.from_diary_to_menu).setOnClickListener(new ToWindowOnClick(this, MyMenuActivity.class));
    ...
    public void onViewDayExerCise(View v){
